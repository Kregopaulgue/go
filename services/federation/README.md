...
[Prebuilt binaries](https://github.com/Kregopaulgue/go/releases) of the federation server are available on the [releases page](https://github.com/Kregopaulgue/go/releases).
...
```
go get -u github.com/Kregopaulgue/go/services/federation
```
