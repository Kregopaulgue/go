...
[![GoDoc](https://godoc.org/github.com/Kregopaulgue/go?status.svg)](https://godoc.org/github.com/Kregopaulgue/go)
[![Go Report Card](https://goreportcard.com/badge/github.com/Kregopaulgue/go)](https://goreportcard.com/report/github.com/Kregopaulgue/go)
...
In addition to the packages described above, this repository contains various packages related to working with the Stellar network from a go program.  It's recommended that you use [godoc](https://godoc.org/github.com/Kregopaulgue/go#pkg-subdirectories) to browse the documentation for each.
